...
<Steps>
  <Step title="Clone the repository">
    ...
    ```bash
    git clone https://github.com/yourusername/joystick.git
    cd joystick
    ```
  </Step>
...
<Warning>
  If you continue experiencing issues, check the [GitHub Issues](https://github.com/yourusername/joystick/issues) or consult the detailed service logs.
</Warning>